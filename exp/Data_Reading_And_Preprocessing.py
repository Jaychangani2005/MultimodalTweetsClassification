...
tsv_data_files = {'humanitarian_task_tsv_files':
                  ('E:/notebooks/MultimodalTweetsClassification/data/crisismmd_datasplit_all/task_humanitarian_text_img_agreed_lab_train.tsv',
                   'E:/notebooks/MultimodalTweetsClassification/data/crisismmd_datasplit_all/task_humanitarian_text_img_agreed_lab_dev.tsv',
                   'E:/notebooks/MultimodalTweetsClassification/data/crisismmd_datasplit_all/task_humanitarian_text_img_agreed_lab_test.tsv'),
                  'Informativeness_task_tsv_files': ('E:/notebooks/MultimodalTweetsClassification/data/crisismmd_datasplit_all/task_informative_text_img_agreed_lab_train.tsv',
                                                     'E:/notebooks/MultimodalTweetsClassification/data/crisismmd_datasplit_all/task_informative_text_img_agreed_lab_dev.tsv',
                                                     'E:/notebooks/MultimodalTweetsClassification/data/crisismmd_datasplit_all/task_informative_text_img_agreed_lab_test.tsv')
                  }
...
def get_image_data(dataframe, path, image_size=224, batch_size=16):
    tfms = get_transforms()
    image_data = (ImageList.from_df(dataframe, path/'data/CrisisMMD_v2', cols='image')
...
def get_test_image_data(dataframe, path, image_size=224, batch_size=16):
    tfms = get_transforms()
    test_image_data = (ImageList.from_df(dataframe, path/'data/CrisisMMD_v2', cols='image')
                       .split_none()
                       .label_from_df(cols='label_image')
                       .transform(tfms, size=image_size)
                       .databunch(bs=batch_size)
